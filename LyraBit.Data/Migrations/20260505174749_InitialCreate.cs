    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupWallets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupWalletMembers", x => new { x.GroupWalletsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_GroupWalletMembers_GroupWallets_GroupWalletsId",
                        column: x => x.GroupWalletsId,
                        principalTable: "GroupWallets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupWalletMembers_Users_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupWalletMembers_MembersId",
                table: "GroupWalletMembers",
                column: "MembersId");
